...
import com.MultipleTableFetch.Repository.NotificationRepository;
...
public class FCMService {
    ...
    /*   public void sendMessage(Map<String, String> data, PushNotificationRequest request)
           ...
           com.MultipleTableFetch.Entity.Notification notification = new com.MultipleTableFetch.Entity.Notification();
           notification.setMessage(request.getMessage());
           notification.setTopic(request.getTopic());
           notification.setTitle("");
           notification.setUserId(request.getUserId());
           notification.setCourseId(request.getCourseId());
           notification.setUserName(userUsingId.getFullName());
